...
namespace Quicktris
{
    class Program
    {
        static class Playfield
        {
            ...
            private static void Array_Clear(int[,] array, int row)
            {
                // will do this in JS
            }

            private static void Array_Copy(int[,] src, int srcRow, int[,] dest, int destRow)
            {
                // will do this in JS
            }
        ...
        static Date Subtract(Date date, int ms)
        {
            // will do this in JS
            return null;
        }
