...
JSTe3s.Block.render=function(){JSTe3s.Playfield.updateBlock();renderer_RenderBlock();}
JSTe3s.Block.moveLeft=function(){if(JSTe3s.Block.check(JSTe3s.Block.mBlock.mPosX-1,JSTe3s.Block.mBlock.mPosY,JSTe3s.Block.mBlock.mRot)){JSTe3s.Block.mBlock.mPosX--;JSTe3s.Block.render();return true;}return false;}
JSTe3s.Block.moveRight=function(){if(JSTe3s.Block.check(JSTe3s.Block.mBlock.mPosX+1,JSTe3s.Block.mBlock.mPosY,JSTe3s.Block.mBlock.mRot)){JSTe3s.Block.mBlock.mPosX++;JSTe3s.Block.render();return true;}return false;}
JSTe3s.Block.moveDown=function(){if(JSTe3s.Block.check(JSTe3s.Block.mBlock.mPosX,JSTe3s.Block.mBlock.mPosY+1,JSTe3s.Block.mBlock.mRot)){JSTe3s.Block.mBlock.mPosY++;JSTe3s.Block.render();return true;}return false;}
JSTe3s.Block.rotate=function(){var $0=(JSTe3s.Block.mBlock.mRot+1)%4;if(JSTe3s.Block.check(JSTe3s.Block.mBlock.mPosX,JSTe3s.Block.mBlock.mPosY,$0)){JSTe3s.Block.mBlock.mRot=$0;JSTe3s.Block.render();return true;}return false;}
